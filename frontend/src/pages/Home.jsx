  ...
  const features = [
    {
      ...
      description:
        "Advanced AI algorithms analyze your documents in seconds, extracting key insights and identifying potential risks.",
    },
    {
      icon: Shield,
      title: "Risk Assessment",
      description:
        "Comprehensive risk evaluation with color-coded highlights to help you make informed decisions.",
    },
    {
      icon: Zap,
      title: "Instant Results",
      description:
        "Get detailed analysis and summaries instantly, saving hours of manual document review.",
    },
  ];
